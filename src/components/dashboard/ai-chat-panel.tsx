...
export function AiChatPanel({ jobId }: AiChatPanelProps) {
  ...
  return (
    ...
    // We use explicit style to ensure it works regardless of Tailwind JIT state
    <div 
      className="border border-border/50 rounded-xl bg-card overflow-hidden flex flex-col"
      style={{ height: "600px", maxHeight: "calc(100vh - 240px)" }}
    >
      {/* Header */}
      ...
      {/* Messages wrapper — min-h-0 is CRITICAL for flexbox scrolling to work properly */}
      <div
        ref={scrollRef}
